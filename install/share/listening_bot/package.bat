...
call:call_file "%%COLCON_CURRENT_PREFIX%%\share\listening_bot\hook\pythonpath.bat"
call:call_file "%%COLCON_CURRENT_PREFIX%%\share\listening_bot\hook\ament_prefix_path.bat"
